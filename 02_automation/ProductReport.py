...
//<![CDATA[
var gl = window.gl || {};
gl.startup_calls = {"/m-melnikova-2/reporting/-/blob/master/ProductReport.py?format=json\u0026viewer=simple":{}};
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"AEvFwrqzxEnCMNhjrn5+mg8739UpBtDpyKyzE9AIZRmr+KSIRICu6cbSi0td5kYEeynQPiQYM8sSrX+8Ec7RnQ==","x-gitlab-feature-category":"source_code_management"};
...
<meta content="ProductReport.py · master · Маргарита Мельникова / Reporting" property="og:title">
...
<meta content="https://git.lab.karpov.courses/m-melnikova-2/reporting/-/blob/master/ProductReport.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="ProductReport.py · master · Маргарита Мельникова / Reporting" property="twitter:title">
...
<title>ProductReport.py · master · Маргарита Мельникова / Reporting · GitLab</title>
...
<meta name="csrf-token" content="lfu5tabiUgWqTQyOfnh3hJEPgJ0PAPWOuxX+Pptbjyw+SNj/WNE4pa6vX6aN4E8a5R2PdgIeFqxhFDKRWp07qA==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8 gl-browser-safari gl-platform-mac" data-find-file="/m-melnikova-2/reporting/-/find_file/master" data-namespace-id="1976" data-page="projects:blob:show" data-page-type-id="master/ProductReport.py" data-project="reporting" data-project-id="322">
...
<div class="js-signature-container" data-signatures-path="/m-melnikova-2/reporting/-/commits/346839f507eb2bc0d63797a7a2fcb8ef0917f692/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="ProductReport.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/m-melnikova-2/reporting/-/blob/master/ProductReport.py"><strong>ProductReport.py</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/m-melnikova-2/reporting/-/blame/master/ProductReport.py">Blame</a><a class="gl-button btn btn-default" href="/m-melnikova-2/reporting/-/commits/master/ProductReport.py">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/m-melnikova-2/reporting/-/blob/346839f507eb2bc0d63797a7a2fcb8ef0917f692/ProductReport.py">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-346839f5">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/m-melnikova-2/reporting/-/commit/346839f507eb2bc0d63797a7a2fcb8ef0917f692">adjusted activation query</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
346839f5
</span>
<div class="committer">
<a class="commit-author-link" href="mailto:melnikovamargaritam@gmail.com">Margarita-3M</a> authored <time class="js-timeago" title="Jan 28, 2022 4:31pm" datetime="2022-01-28T16:31:38Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Jan 28, 2022</time>
</div>

</div>
<div class="commit-actions flex-row">

<a class="ci-status-link ci-status-icon-failed d-inline-flex " title="Pipeline: failed" data-toggle="tooltip" data-placement="left" data-container="body" href="/m-melnikova-2/reporting/-/commit/346839f507eb2bc0d63797a7a2fcb8ef0917f692/pipelines?ref=master"><svg class="s24" data-testid="status_failed-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#status_failed"></use></svg></a>
<div class="js-commit-pipeline-status" data-endpoint="/m-melnikova-2/reporting/-/commit/346839f507eb2bc0d63797a7a2fcb8ef0917f692/pipelines?ref=master"></div>
<div class="commit-sha-group btn-group d-none d-sm-flex">
<div class="label label-monospace monospace">
346839f5
</div>
<button class="btn gl-button btn btn-default btn-icon" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="gl-button btn btn-default btn-icon" data-clipboard-text="346839f507eb2bc0d63797a7a2fcb8ef0917f692" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;ProductReport.py&quot;,&quot;gfm&quot;:&quot;`ProductReport.py`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
11.1 KB
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-action="click_edit" data-track-label="edit" href="/m-melnikova-2/reporting/-/edit/master/ProductReport.py">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-action="click_edit_ide" data-track-label="web_ide" data-track-property="secondary" href="/-/ide/project/m-melnikova-2/reporting/edit/master/-/ProductReport.py">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;a3eb943c5d892fee07772feb24c60d6e9f253ba3&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/m-melnikova-2/reporting/-/raw/master/ProductReport.py"><svg class="s16" data-testid="doc-code-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#doc-code"></use></svg></a>
<a download="ProductReport.py" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/m-melnikova-2/reporting/-/raw/master/ProductReport.py?inline=false"><svg class="s16" data-testid="download-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/m-melnikova-2/reporting/-/blob/master/ProductReport.py">Fork</a>
...
<div class="blob-viewer" data-path="ProductReport.py" data-type="simple" data-url="/m-melnikova-2/reporting/-/blob/master/ProductReport.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete ProductReport.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/m-melnikova-2/reporting/-/blob/master/ProductReport.py" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="M50QNyuSOwVeIOlgTsMeNu9ei2QVrR1yQa70ebUHwm6YLnF91aFRpVrCuki9Wyaom0yEjxiz/lCbrzjWdMF26g==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-477ec04259b7ba30e1130b981a9c09df">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-477ec04259b7ba30e1130b981a9c09df" class="form-control gl-form-input js-commit-message" placeholder="Delete ProductReport.py" data-qa-selector="commit_message_field" required="required" rows="3">
Delete ProductReport.py</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-e077b781068dd34d48c46cd870a0724c" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-e077b781068dd34d48c46cd870a0724c">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace ProductReport.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/m-melnikova-2/reporting/-/update/master/ProductReport.py" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="reHp6TbibkzHdGNCNrPHaMLF9SAZgP2ORraBN1IovOgGUoijyNEE7MOWMGrFK//2ttf6yxSeHqyct02Yk+4IbA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-ac28830ee8a0bd2c7d917e9c3b724095">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ac28830ee8a0bd2c7d917e9c3b724095" class="form-control gl-form-input js-commit-message" placeholder="Replace ProductReport.py" data-qa-selector="commit_message_field" required="required" rows="3">
Replace ProductReport.py</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-feaabf35316c356ff5ca93317a03af3a" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-feaabf35316c356ff5ca93317a03af3a">Start a <strong>new merge request</strong> with these changes
</label></div>
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/m-melnikova-2/reporting/edit/master/-/ProductReport.py'
