...
//<![CDATA[
var gl = window.gl || {};
gl.startup_calls = {"/m-melnikova-2/reporting/-/blob/master/FeedReporting.py?format=json\u0026viewer=simple":{}};
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"DVjdGxTynPLgxaV7O2T+QA5rfDrYLrgKnu8SnHJu+fam67xR6sH2UuQn9lPI/Mbeenlz0dUwWyhE7t4zs6hNcg==","x-gitlab-feature-category":"source_code_management"};
...
<meta content="FeedReporting.py · master · Маргарита Мельникова / Reporting" property="og:title">
...
<meta content="https://git.lab.karpov.courses/m-melnikova-2/reporting/-/blob/master/FeedReporting.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="FeedReporting.py · master · Маргарита Мельникова / Reporting" property="twitter:title">
...
<title>FeedReporting.py · master · Маргарита Мельникова / Reporting · GitLab</title>
...
<meta name="csrf-token" content="9Wh/WXi6GRpKxfb0lV2qiXVZsKtxS1TEyg3dozqdzaFe2x4Tholzuk4npdxmxZIXAUu/QHxVt+YQDBEM+1t5JQ==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8 gl-browser-safari gl-platform-mac" data-find-file="/m-melnikova-2/reporting/-/find_file/master" data-namespace-id="1976" data-page="projects:blob:show" data-page-type-id="master/FeedReporting.py" data-project="reporting" data-project-id="322">
...
<div class="js-signature-container" data-signatures-path="/m-melnikova-2/reporting/-/commits/10311725d6109cb6d230755f47633a1ebb87e828/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="FeedReporting.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/m-melnikova-2/reporting/-/blob/master/FeedReporting.py"><strong>FeedReporting.py</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/m-melnikova-2/reporting/-/blame/master/FeedReporting.py">Blame</a><a class="gl-button btn btn-default" href="/m-melnikova-2/reporting/-/commits/master/FeedReporting.py">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/m-melnikova-2/reporting/-/blob/346839f507eb2bc0d63797a7a2fcb8ef0917f692/FeedReporting.py">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-10311725">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/m-melnikova-2/reporting/-/commit/10311725d6109cb6d230755f47633a1ebb87e828">optimized request to BD for Feed Reporting</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
10311725
</span>
<div class="committer">
<a class="commit-author-link" href="mailto:melnikovamargaritam@gmail.com">Margarita-3M</a> authored <time class="js-timeago" title="Jan 28, 2022 1:21pm" datetime="2022-01-28T13:21:43Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Jan 28, 2022</time>
</div>

</div>
<div class="commit-actions flex-row">

<a class="ci-status-link ci-status-icon-failed d-inline-flex " title="Pipeline: failed" data-toggle="tooltip" data-placement="left" data-container="body" href="/m-melnikova-2/reporting/-/commit/10311725d6109cb6d230755f47633a1ebb87e828/pipelines?ref=master"><svg class="s24" data-testid="status_failed-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#status_failed"></use></svg></a>
<div class="js-commit-pipeline-status" data-endpoint="/m-melnikova-2/reporting/-/commit/10311725d6109cb6d230755f47633a1ebb87e828/pipelines?ref=master"></div>
<div class="commit-sha-group btn-group d-none d-sm-flex">
<div class="label label-monospace monospace">
10311725
</div>
<button class="btn gl-button btn btn-default btn-icon" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="gl-button btn btn-default btn-icon" data-clipboard-text="10311725d6109cb6d230755f47633a1ebb87e828" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;FeedReporting.py&quot;,&quot;gfm&quot;:&quot;`FeedReporting.py`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
4.69 KB
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-action="click_edit" data-track-label="edit" href="/m-melnikova-2/reporting/-/edit/master/FeedReporting.py">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-action="click_edit_ide" data-track-label="web_ide" data-track-property="secondary" href="/-/ide/project/m-melnikova-2/reporting/edit/master/-/FeedReporting.py">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;36ea2f1c1510a4122cd1a93939c7975ae86ac9db&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/m-melnikova-2/reporting/-/raw/master/FeedReporting.py"><svg class="s16" data-testid="doc-code-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#doc-code"></use></svg></a>
<a download="FeedReporting.py" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/m-melnikova-2/reporting/-/raw/master/FeedReporting.py?inline=false"><svg class="s16" data-testid="download-icon"><use href="/assets/icons-7f1680a3670112fe4c8ef57b9dfb93f0f61b43a2a479d7abd6c83bcb724b9201.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/m-melnikova-2/reporting/-/blob/master/FeedReporting.py">Fork</a>
...
<div class="blob-viewer" data-path="FeedReporting.py" data-type="simple" data-url="/m-melnikova-2/reporting/-/blob/master/FeedReporting.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete FeedReporting.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/m-melnikova-2/reporting/-/blob/master/FeedReporting.py" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="JTU5bNb7tuEuy+zEBGTRGxqdd2DmPWEMCioqgbhVD8COhlgmKMjcQSopv+z3/OmFbo94i+sjgi7QK+YueZO7RA==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-3d34ab71af7dd4dc9c3787c57ad4d186">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-3d34ab71af7dd4dc9c3787c57ad4d186" class="form-control gl-form-input js-commit-message" placeholder="Delete FeedReporting.py" data-qa-selector="commit_message_field" required="required" rows="3">
Delete FeedReporting.py</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-cae71a98c44e55f23b4fb38389935e6c" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-cae71a98c44e55f23b4fb38389935e6c">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace FeedReporting.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/m-melnikova-2/reporting/-/update/master/FeedReporting.py" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="rB+boxWfurvJhREX+DkoaLnXa4tNetAlTe8S/9AU1b0HrPrp66zQG81nQj8LoRD2zcVkYEBkMweX7t5QEdJhOQ==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-ca9c8dc3dc277c4de4b987e510ad631c">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ca9c8dc3dc277c4de4b987e510ad631c" class="form-control gl-form-input js-commit-message" placeholder="Replace FeedReporting.py" data-qa-selector="commit_message_field" required="required" rows="3">
Replace FeedReporting.py</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-426a833002ad80dd2fb84d26c19396b0" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-426a833002ad80dd2fb84d26c19396b0">Start a <strong>new merge request</strong> with these changes
</label></div>
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/m-melnikova-2/reporting/edit/master/-/FeedReporting.py'
